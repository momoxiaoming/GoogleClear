...
import com.mckj.template.databinding.CleanLottieHeaderStyle02Binding
import com.mckj.template.impl.IAction
import org.jetbrains.anko.textColor

open class LottieCleanHeaderStyle02(context: Context, iAction: IAction) :
    AbsCleanLottieHeader<CleanLottieHeaderStyle02Binding>(context, iAction) {
    ...
    override fun getResId(): Int {
        return R.layout.clean_lottie_header_style_02
    }
