package com.mckj.cleancore.tools.wechat
 ...
 */
class WechatCacheTool : AbsJunkTool() {

    companion object {
        const val TAG = "WechatCacheTool"
    }
    ...
    override fun scan(consumer: Consumer<IJunkEntity>): Boolean {
        ...
        val appList = mutableListOf<String>("com.tencent.mm")
        ...
        AppJunkHelper.parseAppJunk(JunkType.WECHAT, AppJunkHelper.getAppMap(appList, allAppJunkList), consumer)
        return true
    }
