...
import com.mckj.gallery.BuildConfig;
...
public class GalleryLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int mScrollPosition = NO_POSITION;
    /**
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (mScrollPosition != NO_POSITION) {
            mInitialSelectedPosition = mScrollPosition;
            detachAndScrapAttachedViews(recycler);
            firstFillCover(recycler, state, 0);
            mScrollPosition = NO_POSITION;
            return;
        }
