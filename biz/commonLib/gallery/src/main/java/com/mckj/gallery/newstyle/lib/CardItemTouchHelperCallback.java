package com.mckj.gallery.newstyle.lib;
...
public class CardItemTouchHelperCallback<T> extends ItemTouchHelper.Callback {
    ...
    public CardItemTouchHelperCallback(@NonNull RecyclerView.Adapter adapter, @NonNull LinkedList<T> dataList) {
        this.adapter = checkIsNull(adapter);
        this.dataList = checkIsNull(dataList);
    }

    public CardItemTouchHelperCallback(@NonNull RecyclerView.Adapter adapter, @NonNull LinkedList<T> dataList, OnSwipeListener<T> listener) {
        this.adapter = checkIsNull(adapter);
        this.dataList = checkIsNull(dataList);
