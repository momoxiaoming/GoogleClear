 ...
 */
@Route(path = ARouterPath.Cleanupx.FRAGMENT_TAB_FONT_SCALE)
class FontScaleTabFragment: DataBindingFragment<FontScaleFragmentBinding, FontScaleViewModel>() {
    companion object{
    ...
    override fun initView() {
        mBinding.apply {
            fontScaleTitleBar.apply {
                ...
                setBackColor()
                showSetIcon()
                setTitleLeftMargin(13)
                showBackIconState(false)
                setTitleSize(18f)
