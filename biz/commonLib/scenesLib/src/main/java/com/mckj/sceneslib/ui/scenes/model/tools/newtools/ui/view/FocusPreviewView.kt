...
/**
 * @Description
 * @CreateTime 2022/3/23 11:35
 * @Author xujianjun
 */
class FocusPreviewView @JvmOverloads constructor(
    ...
    private var mAnimation: Animation = AnimationUtils.loadAnimation(getContext(), R.anim.focusview_show)
    ...
    init {
        ...
        mFocusFailedImg = typedArray.getResourceId(
            R.styleable.FocusImageView_focus_fail_id,
            NO_ID
        )
        typedArray.recycle()
