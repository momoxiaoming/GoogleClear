...
public final class RomUtils
{
    ...
    private static final String VERSION_PROPERTY_HONOR = "ro.huawei.build.display.id";
     ...
     * 获取emui大版本号
     *
     * @return example: 11.0.0.168 返回 11
     */
    public static int getEmuiVer() {
        RomInfo info = getRomInfo();
        if (info != null && info.version != null) {
            //example:
            //ana-an00 11.0.0.168(c00e160r3p6)
            //lra-al00 10.1.0.152(c00e145r6p3)
            Pattern pattern = Pattern.compile("(\\d+)(\\.)");
            Matcher matcher = pattern.matcher(info.version);
    ...
    public static RomInfo getRomInfo() {
        ...
        //从华为荣耀v30后属于荣耀手机了
        //荣耀v30 brand=honor,manufacturer=huawei
        //荣耀40  brand=honor,manufacturer=honor
    ...
    private static String getSystemPropertyByShell(final String propName) {
        // bug:  直接调用shell , 是有一定概率被 stdio卡死的
        String line;
